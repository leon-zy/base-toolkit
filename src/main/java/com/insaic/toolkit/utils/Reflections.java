...
/**
 * Reflections
 * Created by leon_zy on 2018/12/21
 */
public class Reflections {
    private static final String SETTER_PREFIX = "set";
    private static final String GETTER_PREFIX = "get";
    private static final String CGLIB_CLASS_SEPARATOR = "$$";
    private static Logger logger = LoggerFactory.getLogger(com.insaic.base.utils.Reflections.class);
    ...
    public static Class<?> getType(String entityName) {
        try {
            ...
            logger.error("Method getType:", var2);
            return null;
        }
    }
    ...
    public static String getGetterMethodName(String fieldName, Class<?> fieldType) {
        ...
        if (fieldType == null) {
            ...
            if (fieldType.getName().equals("boolean")) {
                methodName = "is" + StringUtil.upperFirst(fieldName);
            } else {
                methodName = "get" + StringUtil.upperFirst(fieldName);
            }
    ...
    public static String getGetterMethodName(String fieldName) {
        return getGetterMethodName(fieldName, (Class)null);
    }
    ...
    public static Method getGetterMethod(Class<?> c, String fieldName) {
        return getGetterMethod(c, fieldName, (Class)null);
    }
}